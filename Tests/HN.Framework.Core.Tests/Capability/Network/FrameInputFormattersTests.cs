...
namespace HN.Framework.Core.Tests.Capability.Network
{
    ...
    public class FrameInputFormattersTests
    {
        ...
        public void Serialize_Deserialize_Roundtrip()
        {
            ...
            original.AddAction("Horizontal", new Fixed64(1.5f));
            original.AddAction("Vertical", new Fixed64(-0.5f));
            ...
            Assert.That(result.Actions["Horizontal"], Is.EqualTo(new Fixed64(1.5f)));
            Assert.That(result.Actions["Vertical"], Is.EqualTo(new Fixed64(-0.5f)));
