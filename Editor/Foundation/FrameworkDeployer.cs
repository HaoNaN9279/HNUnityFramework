...
namespace HN.Framework.Editor
{
    public static class FrameworkDeployer
    {
        public static void Deploy()
        {
            ...
            HN.Framework.Unity.Capability.Audio.AudioSettings.GetOrCreateSettings();
            HN.Framework.Unity.Level.View.UI.UISettings.GetOrCreateSettings();
            HN.Framework.Unity.Capability.Network.NetworkSettings.GetOrCreateSettings();
            HN.Framework.Unity.Capability.Asset.AssetSettings.GetOrCreateSettings();
            HN.Framework.Unity.Capability.Cutscene.CutsceneSettings.GetOrCreateSettings();
            HN.Framework.Unity.Capability.AI.AISettings.GetOrCreateSettings();
            HN.Framework.Editor.Scripting.HybridCLRSettings.GetOrCreateSettings();
