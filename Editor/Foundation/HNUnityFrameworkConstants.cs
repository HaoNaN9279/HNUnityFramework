...
namespace HN.Framework.Editor
{
    public static class HNUnityFrameworkConstants
    {
        ...
        /// </summary>
        public const string ADDRESSABLES_ASSETS_DEFAULT_LOCAL_BUNDLED_ASSET_SCHEMA = "Assets/AddressableAssetsData/AssetGroups/Schemas/Default Local Group_BundledAssetGroupSchema.asset";
        /// <summary>
        /// 默认本地资源组的 ContentUpdateGroupSchema 文件路径。
        /// </summary>
        public const string ADDRESSABLES_ASSETS_DEFAULT_LOCAL_CONTENT_UPDATE_SCHEMA = "Assets/AddressableAssetsData/AssetGroups/Schemas/Default Local Group_ContentUpdateGroupSchema.asset";
        /// <summary>
