...
public partial struct Fixed4x4
{
    ...
    public static Fixed4x4 operator *(Fixed4x4 lhs, Fixed4x4 rhs)
    {
        ...
        {
            // Optimized affine multiplication (skips full 4¡Á4 multiplication)
            return new Fixed4x4(
        ...
        // Full 4¡Á4 multiplication (fallback for perspective matrices)
        return new Fixed4x4(
            // Upper-left 3¡Á3 matrix multiplication (rotation & scale)
