...
#endif
{
    ...
    /// <summary>
    /// Represents the mathematical constant 2�� as a fixed-point value.
    /// </summary>
    /// <remarks>This value is commonly used to represent a full rotation in radians.</remarks>
    public static Fixed64 TwoPi => Pi * Two;
    /// <summary>
    /// Represents the mathematical constant �� divided by 2 as a fixed-point value.
    /// </summary>
    /// <remarks>This value is used where ��/2 is required.</remarks>
    public static Fixed64 HalfPi => Pi / new Fixed64(2);
    /// <summary>
    /// Represents the mathematical constant �� divided by 3 as a fixed-point value.
    /// </summary>
    public static Fixed64 PiOver3 => Pi / new Fixed64(3);
    /// <summary>
    /// Represents the mathematical constant �� divided by 4 as a fixed-point value.
    /// </summary>
    public static Fixed64 PiOver4 => Pi / new Fixed64(4);
    /// <summary>
    /// Represents the mathematical constant �� divided by 6 as a fixed-point value.
    /// </summary>
    public static Fixed64 PiOver6 => Pi / new Fixed64(6);
    /// <summary>
    /// Represents the multiplicative inverse of the mathematical constant �� (pi) as a fixed-point value.
    /// </summary>
    ...
    /// <summary>
    /// Degrees to radians conversion factor (�� / 180)
    /// </summary>
    public static Fixed64 Deg2Rad => Pi / OneEighty;
    /// <summary>
    /// Radians to degrees conversion factor (180 / ��)
    /// </summary>
    ...
    public Fixed64(long m_rawValue) => this.m_rawValue = m_rawValue;
